...
def main():
    ...
    while display_start:
        ...
        # Проверяем действия с кнопками на игровом дисплее
        ...
        for enemy in enemies:
            ...
            if ((player.horizontal_coordinate + player.width > enemy.horizontal_coordinate) and
                (player.horizontal_coordinate < enemy.horizontal_coordinate + enemy.width) and
                (player.vertical_coordinate + player.height > enemy.vertical_coordinate)):
                display_start = False
